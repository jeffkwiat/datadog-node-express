...
global.db = mongoose.createConnection(url, { useNewUrlParser: true }); // connect to our database

db.on('error', function() {
    debug('MongoDB Connection Error');
    configDB.mongo_set_connected(false);
});

db.once('open', function() {
  // we're connected!
  debug("Connected to Mongo yo.");
  configDB.mongo_set_connected(true);
});
// RedisStore
